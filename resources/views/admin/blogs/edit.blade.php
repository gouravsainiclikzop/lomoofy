                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-md-6">
                            ...
                            <div id="currentThumbnail" class="mt-2">
                                <img src="{{ asset('storage/' . $blog->thumbnail_image) }}" alt="Current" class="image-preview">
                        ...
                        <div class="col-md-6">
                            ...
                            <div id="currentFeatured" class="mt-2">
                                <img src="{{ asset('storage/' . $blog->featured_image) }}" alt="Current" class="image-preview">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" class="form-control" id="addedBy" name="added_by" value="{{ $blog->added_by }}" placeholder="e.g., Admin">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="date" class="form-control" id="publishedDate" name="published_date" value="{{ $blog->published_date ? $blog->published_date->format('Y-m-d') : '' }}">
                        ...
                        <div class="col-12">
                            ...
                            <textarea id="description" name="description" style="display: none;">{{ $blog->description }}</textarea>
