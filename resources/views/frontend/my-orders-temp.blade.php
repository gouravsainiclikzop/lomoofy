							...
							<div class="d-block border rounded">
								...
								<div class="dashboard_author">
									...
									<ul class="dahs_navbar">
										<li><a href="my-orders.html" class="active"><i class="lni lni-shopping-basket me-2"></i>My Order</a></li>
										<li><a href="wishlist.html"><i class="lni lni-heart me-2"></i>Wishlist</a></li>
										<li><a href="profile-info.html"><i class="lni lni-user me-2"></i>Profile Info</a></li>
										<li><a href="addresses.html"><i class="lni lni-map-marker me-2"></i>Addresses</a></li>
										<li><a href="payment-methode.html"><i class="lni lni-mastercard me-2"></i>Payment Methode</a></li>
