...
class FieldManagementSeeder extends Seeder
{
    ...
    public function run(): void
    {
        $fields = [
            ...
            [
                'field_key' => 'make_default_address',
            ...
            [
                ...
                'conditional_rules' => null,
                'validation_rules' => null,
                'help_text' => 'Internal tags for categorization',
                'is_active' => true,
            ],
            [
                'field_key' => 'risk_flags',
                'label' => 'Risk Flags',
                'input_type' => 'text',
                'placeholder' => 'Enter risk flags (comma separated)',
                'is_required' => false,
                'is_visible' => false,
                'sort_order' => 61,
                'field_group' => 'internal',
                ...
                'conditional_rules' => null,
                'validation_rules' => null,
                'help_text' => 'Internal risk assessment flags',
                'is_active' => true,
            ],
            [
                'field_key' => 'notes',
            ...
            [
                ...
                'help_text' => 'Credit limit in rupees',
                'is_active' => true,
            ],
            [
            ...
            [
                ...
                'help_text' => 'Default discount percentage for this customer (0-100)',
                'is_active' => true,
            ],
            [
            ...
            [
                ...
                'conditional_rules' => null,
                'validation_rules' => null,
                'help_text' => 'Date when customer first registered',
                'is_active' => true,
            ],
            [
                'field_key' => 'last_order_date',
                ...
                'conditional_rules' => null,
                'validation_rules' => null,
                'help_text' => 'Date of last order placed',
                'is_active' => true,
            ],
            [
                'field_key' => 'total_orders',
                'label' => 'Total Orders',
                'input_type' => 'number',
            ...
            [
                ...
                'conditional_rules' => null,
                'validation_rules' => 'numeric|min:0',
                'help_text' => 'Total amount spent in rupees',
                'is_active' => true,
            ],
            [
                ...
                'conditional_rules' => null,
                'validation_rules' => null,
                'help_text' => 'Any special instructions or notes for this customer',
                'is_active' => true,
            ],
        ];
            ...
            foreach ($fields as $field) {
                ...
                $exists = DB::table('field_management_fields')
                    ->where('field_key', $fieldData['field_key'])
                    ->exists();
                
                if (!$exists) {
                    DB::table('field_management_fields')->insert(array_merge($fieldData, [
                        'created_at' => now(),
                        'updated_at' => now(),
                    ]));
                }
