...
class FrontendController extends Controller
{
    public function index(Request $request)
    {
        ...
        return view('frontend.index', compact('parentCategories', 'newArrivals'));
    }
    ...
    public function shop(Request $request)
    {
        ...
        return view('frontend.shop', compact('selectedCategory', 'childCategories', 'parentCategories', 'breadcrumb'));
    }
